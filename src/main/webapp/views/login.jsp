                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse flex-grow-0" id="navbarNav">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#reserva">Reservá</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/final/login" id="login">Iniciar sesión</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="contact_section" id="form_user">
                <div class="form_container">
                    ...
                    <form method="post" action="">
                        <div>
                            <div class="campo_container" style="display: block; width: 100%;">
                                ...
                                <input class="campo" type="text" name="email" id="email" placeholder="Ingresá tu email">
                            </div>
                            <div class="campo_container" style="display: block; width: 100%;">
                    ...
                    <div id="info_register">
                        <p>¿No tenés cuenta? Registrate <a href="/final/registro">ACÁ</a></p>
                    </div>
                </div>
            </div>
        </section>
    ...
    <footer>
        <div class="footer_container">
            <article class="footer_logo">
                ...
                <div>
                    <p>Inigualable experiencia de sabor y placer acompañan tu velada. ¡Te esperamos!</p>
                </div>
            </article>
            <div class="footer_contains">
                ...
                <article>
                    ...
                    <ul id="footer_social">
                        <li><a href="http://www.facebook.com" target="_blank" rel="noopener noreferrer"><i
                                    class="fa-brands fa-facebook"></i></a></li>
                        <li><a href="http://www.instagram.com" target="_blank" rel="noopener noreferrer"><i
                                    class="fa-brands fa-instagram"></i></a></li>
                        <li><a href="http://www.twitter.com" target="_blank" rel="noopener noreferrer"><i
                                    class="fa-brands fa-x-twitter"></i></a></li>
                        <li><a href="https://github.com/BrianFloresOk" target="_blank" rel="noopener noreferrer"><i
